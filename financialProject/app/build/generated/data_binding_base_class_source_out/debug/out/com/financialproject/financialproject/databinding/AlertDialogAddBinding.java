...
public final class AlertDialogAddBinding implements ViewBinding {
  ...
  @NonNull
  public static AlertDialogAddBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AlertDialogAddBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.alert_dialog_add, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AlertDialogAddBinding bind(@NonNull View rootView) {
    if (rootView == null) {
